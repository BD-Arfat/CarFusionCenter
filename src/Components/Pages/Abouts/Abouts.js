...
const Abouts = () => {
    return (
        <div>
            <h1 className='text-center font-bold text-3xl md:text-4xl mt-5'>Here is some information about our Products</h1>
            <div className='mt-10 mb-28'>
                <p className='text-justify w-11/12 mx-auto'>
                    A car or an automobile is a motor vehicle with wheels. Most definitions of cars say that they run primarily on roads, seat one to eight people, have four wheels, and mainly transport people, not cargo.[1][2]
